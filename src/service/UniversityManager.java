...
public class UniversityManager {
    ...
    public void enroll(String studentId, String courseCode, double grade)
        ...
        if (c.isFull()) throw new CourseFullException("Course is full.");
        ...
        c.addStudent(s);
        // Update GPA
        double total = s.getEnrolledCourses().values().stream().mapToDouble(Double::doubleValue).sum();
